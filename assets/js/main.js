(function ($) {
    ...
    $(".testimonial-slider-v1").owlCarousel({ items: 1, nav: false, dot: true, loop: true, margin: 10, smartSpeed: 1500, responsiveClass: true, responsive: { 0: { autoHeight: true }, 768: { items: 1 } } });
    $(".testimonial-slider-v2").owlCarousel({ items: 1, nav: false, dot: true, loop: true, margin: 0, smartSpeed: 1500 });
    $(".testimonial-slider-v3").owlCarousel({ items: 1, nav: true, dot: false, animateOut: "fadeOut", navText: ['<i class="flaticon-left-arrow"></i>', '<i class="flaticon-next"></i>'], loop: true, margin: 0, smartSpeed: 3500 });
    $(".about-img-slider").owlCarousel({ items: 1, dot: false, nav: true, loop: true, navText: ["<span>Prev</span>", "<span>Next</span>"], margin: 0, smartSpeed: 1500 });
    ...
    var galleryTop = new Swiper(".gallery-top", { spaceBetween: 10, navigation: { nextEl: ".swiper-button-next", prevEl: ".swiper-button-prev" }, thumbs: { swiper: galleryThumbs } });
